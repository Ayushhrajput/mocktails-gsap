...
function About({prop}) {
    ...
    return (
        <div id={prop} className=''>
            <div className='w-full  flex flex-col md:flex-row justify-between gap-10 px-4 py-10'>
                <div className='flex flex-col gap-4'>
                    <h1 className=' px-8 w-max text-white h-min rounded-4xl bg-gray-400'>Mocktails</h1>
                    <p className='text-4xl style-font'> "Mocktails designed to delight."</p>
                </div>
